...
from .models import Student, CustomUser, Lecturer, OrgStaff, StudentAdmin, OrgAdmin, InstAdmin, InstStaff, Profile
...
admin.register(InstAdmin)
admin.register(InstStaff)
