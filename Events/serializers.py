...
class EventSurveyTemplateSerializer(ModelSerializer):
    questions_count = serializers.SerializerMethodField()
    created_by_name = serializers.SerializerMethodField()

    class Meta:
        model = EventSurveyTemplate
        fields = '__all__'
